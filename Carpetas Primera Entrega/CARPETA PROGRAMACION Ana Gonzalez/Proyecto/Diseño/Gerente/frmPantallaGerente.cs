    ...
    public partial class frmPantallaGerente : Form {
        ...
        InitializeComponent();
           ...
           BtnInicio.ForeColor = Color.White;
            ...
            Logica.leftBorderBtn.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(165)))), ((int)(((byte)(21)))), ((int)(((byte)(80)))));
        ...
        private void frmPantallaGerente_Load(object sender, EventArgs e)
        {
            this.Opacity = 0.0;
            timerAbrir.Start();
        ...
        private void btnInicio_Click(object sender, EventArgs e)
        {
            if(Logica.CurrentButton != BtnInicio) {
                Logica.activarBotonGerente(sender, iconoTitulo);
                lblTitulo.Text = "Inicio";
                this.pnlCargado.Controls.Clear();
                frmInicioGerente frmInicio_carga = new frmInicioGerente()
                {
        ...
        private void btnReservaCliente_Click(object sender, EventArgs e)
        {
            if (Logica.CurrentButton != btnReservaCliente)
            {
                ...
                this.pnlCargado.Controls.Clear();
                frmReservaCliente frmReservaCliente_carga = new frmReservaCliente(panelBotones, "Gerente")
                {
                    Dock = DockStyle.Fill,
                    TopLevel = false,
                    TopMost = true
        ...
        private void btnModificarCliente_Click(object sender, EventArgs e)
        {
            if (Logica.CurrentButton != btnModificarCliente)
            {
                ...
                this.pnlCargado.Controls.Clear();
                frmModificacionCliente frmReservaCliente_carga = new frmModificacionCliente(panelBotones, "Gerente")
                {
                    Dock = DockStyle.Fill,
                    TopLevel = false,
                    TopMost = true
        ...
        {
            if (Logica.CurrentButton != btnGrids)
            {
                Logica.activarBotonGerente(sender, iconoTitulo);
                lblTitulo.Text = "Datos";
                this.pnlCargado.Controls.Clear();
                frmDatos frmReservaCliente_carga = new frmDatos(panelBotones, "Gerente")
                {
                    Dock = DockStyle.Fill,
                    TopLevel = false,
                    TopMost = true
        ...
        {
            if (Logica.CurrentButton != btnPrecios)
            {
                Logica.activarBotonGerente(sender, iconoTitulo);
                lblTitulo.Text = "Modificar Precios";
                this.pnlCargado.Controls.Clear();
                frmModificacionPrecio frmModificacionPrecio_carga = new frmModificacionPrecio()
                {
                    Dock = DockStyle.Fill,
                    TopLevel = false,
                    TopMost = true
                };
                frmModificacionPrecio_carga.FormBorderStyle = FormBorderStyle.None;
                this.pnlCargado.Controls.Add(frmModificacionPrecio_carga);
                frmModificacionPrecio_carga.Show();
            }
        }
        private void frmPantallaGerente_Resize(object sender, EventArgs e)
        {
            banderaResize = "" + this.WindowState;
        }
