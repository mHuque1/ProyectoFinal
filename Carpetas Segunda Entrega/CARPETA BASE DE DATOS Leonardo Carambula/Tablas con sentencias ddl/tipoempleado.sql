...
CREATE TABLE `tipoempleado` (
  ...
  `SueldoPorDefecto` float NOT NULL,
  PRIMARY KEY (`Rol`)
...
INSERT INTO `tipoempleado` VALUES ('Administrativo',34000),('Auxiliar de servicio',21000),('Chofer',30000),('Gerente',100000),('Instuctor de yoga',32000),('Masajista',25000);
